...
public class ProgressView extends View {
    ...
    private void setupPaints() {
        barPaint.setColor(getResources().getColor(R.color.colorWhite));
        barPaint.setAntiAlias(true);
        barPaint.setStyle(Style.STROKE);
        barPaint.setStrokeWidth(barWidth);

        rimPaint.setColor(getResources().getColor(R.color.colorDialog));
        rimPaint.setAntiAlias(true);
        rimPaint.setStyle(Style.STROKE);
        rimPaint.setStrokeWidth(rimWidth);

        circlePaint.setColor(getResources().getColor(R.color.colorDialog));
        ...
        contourPaint.setColor(getResources().getColor(R.color.colorWhite));
